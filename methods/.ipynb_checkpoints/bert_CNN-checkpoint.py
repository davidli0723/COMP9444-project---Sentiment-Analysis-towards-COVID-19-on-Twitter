...
# Main script
def bert_cnn(data_path=r"C:/Users/50643/COMP9444/Project/Data/final_dataset/COVIDSenti-C_cleanest.csv", 
             num_epochs = 3, output_dir = "./sentiment_model_with_bert_bilstm"):
    # Load dataset
