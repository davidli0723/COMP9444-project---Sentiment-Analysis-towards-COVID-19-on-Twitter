...
def main(source='data/COVIDSenti-B.csv', target='data/COVIDSenti_B_base.csv', split_dataset=1, config_p={}):
...
if __name__ == '__main__':
    ...
    main(source='data/COVIDSenti-B.csv', target='test_dataset/B_base_lemmatize.csv', split_dataset=0.2, config_p=config)
