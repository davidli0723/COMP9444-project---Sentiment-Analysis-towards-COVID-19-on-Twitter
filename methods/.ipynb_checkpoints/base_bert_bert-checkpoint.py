...
def main(dataset_path, save_path, num_epochs=10):
...
if __name__ == '__main__':
    ...
    main(dataset_path="G://Coding//PycharmProject//pusht_formal//data//preprocessed//COVIDSenti-A_12000_stem.csv",
         save_path="stemmer_lemma_12000//1031_A_base_stem", num_epochs=15)
    main(dataset_path="G://Coding//PycharmProject//pusht_formal//data//preprocessed//COVIDSenti-A_12000_lemma.csv",
